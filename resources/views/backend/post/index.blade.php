          ...
          <div class="modal-body">
              ...
              <div class="col-12 my-2">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <textarea type="text" class="text-area @error('context') is-invalid @enderror" id="context" name="context" autofocus rows="7">
                    </textarea>
              ...
              <div class="col-12 my-2">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" autofocus required>
            ...
            <div class="container-fluid">
              <div class="col-12 my-2">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control @error('edit_title') is-invalid @enderror" id="edit_title" name="edit_title" autofocus required>
              ...
              <div class="col-12 my-2">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <textarea type="text" class="text-area @error('edit_context') is-invalid @enderror" id="edit_context" name="edit_context" autofocus rows="7">
                    </textarea>
