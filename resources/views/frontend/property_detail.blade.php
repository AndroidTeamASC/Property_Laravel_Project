                ...
                <div class="properties-details-section">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <textarea type="text" class="text-area form-control" id="comment" name="comment" autofocus rows="5" data-id="{{$property->id}}">
                            </textarea>
                        </div>
                    </div>
                    @endif
    ...
    $('#comment').change(function () {
     ...
     $('#comments').on('click','.comment_reply',function (argument) {
        ...
        var html = `<div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <textarea type="text" class="text-area form-control" id="comment${comment_id}" name="comment" autofocus rows="3" data-id="{{$property->id}}">
                            </textarea>
                        </div>
                    </div>`
