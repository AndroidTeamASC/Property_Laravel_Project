          ...
          <table class="table table-bordered align-items-center table-white table-flush example" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody id="medicineTable">
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="<?php echo e(route('agent.property.show',$property->id)); ?>"><i class="btn-sm ni ni-archive-2 text-white bg-success"></i></a>
                          <a href="<?php echo e(route('agent.property.edit',$property->id)); ?>"><i class="btn-sm fas fa-edit text-white"  style="background-color: #5e72e4"></i></a>
...
<?php echo $__env->make('backend.backend_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/backend/property/index.blade.php ENDPATH**/ ?>