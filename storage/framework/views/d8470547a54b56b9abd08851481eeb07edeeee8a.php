                ...
                <div class="form-section align-self-center">
                    ...
                    <form action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <div class="form-group form-box">
                            <input type="email" name="email" class="input-text form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Email Address" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group form-box clearfix">
                            <input type="password" name="password" class="input-text form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/auth/login.blade.php ENDPATH**/ ?>