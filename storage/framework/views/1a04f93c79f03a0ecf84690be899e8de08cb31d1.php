                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    ...
                                    <div class="listing-time opening"><?php echo e($property->status); ?></div>
                            ...
                            <div class="detail">
                                ...
                                <div class="location">
                                    <a href="properties-details.html">
                                        <i class="fa fa-map-marker"></i><?php echo e($property->address); ?>

                                    </a>
                                </div>
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-square"></i> <?php echo e($property->land_area); ?>
                            ...
                            <div class="footer clearfix">
                                <div class="pull-left days">
                                    <a><i class="fa fa-user"></i> <?php echo e($property->name); ?></a>
                                </div>
                                <div class="pull-right">
                                    <a><i class="flaticon-time"></i> <?php echo e(\Carbon\Carbon::parse($property->created_at)->diffForHumans()); ?></a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend/property_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/frontend/property_type.blade.php ENDPATH**/ ?>