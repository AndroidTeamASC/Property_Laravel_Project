          ...
          success: (data) => {
            ...
            $.each(data,function(i,v){
              ...
              html+=`<tr>
                        ...
                        <td>
                          <button class="btn btn-primary btn-sm d-inline-block editTag " data-id="${v.id}"><i class="fas fa-edit text-white"></i></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.backend_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/backend/tag/index.blade.php ENDPATH**/ ?>