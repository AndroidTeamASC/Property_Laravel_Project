<?php $__env->startSection('add'); ?>
  <div class="header pb-6 d-flex align-items-center" style="min-height: 500px; background-image: url(<?php echo e(asset(Auth::user()->image)); ?>); background-size: cover; background-position: center top;">
      <!-- Mask -->
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white"><?php echo e(Auth::user()->name); ?></h1>
...
<div class="row">
  <div class="col-xl-4 order-xl-2">
          <div class="card card-profile">
            <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="Image placeholder" class="card-img-top" style="height: 250px">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="<?php echo e(asset(Auth::user()->image)); ?>" class="rounded-circle" style="height: 150px">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i><?php echo e(Auth::user()->name); ?>

                </div>
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i><?php echo e(Auth::user()->email); ?>

                </div>
                <div>
                  <i class="ni education_hat mr-2"></i><?php echo e(Auth::user()->phone_no); ?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form id="updateButton" method="POST">
                <input type="hidden" name="agent_id" id="agent_id" value="<?php echo e(Auth::user()->id); ?>">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" placeholder="Username" value="<?php echo e(Auth::user()->name); ?>" name="edit_name">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" id="input-email" class="form-control" value="<?php echo e(Auth::user()->email); ?>" name="edit_email">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-address" class="form-control" placeholder="Username" value="<?php echo e(Auth::user()->address); ?>" name="edit_address">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-phone_no">Phone Number</label>
                        <input type="number" id="input-phone_no" class="form-control" value="<?php echo e(Auth::user()->phone_no); ?>" name="edit_phone_no">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="agent_old_image" value="<?php echo e(Auth::user()->image); ?>">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="old_password" value="<?php echo e(Auth::user()->password); ?>">
  ...
  <script type="text/javascript">
    ...
    $('#updateButton').submit(function (e) {
      ...
      for (var pair of formData.entries())
        ...
        var url="<?php echo e(route('agent.update',':id')); ?>";
      ...
      $.ajax({
          ...
          success: function (data) {
            ...
            window.location.href="<?php echo e(route('agent.profile')); ?>"
          },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.backend_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/backend/profile/agent.blade.php ENDPATH**/ ?>