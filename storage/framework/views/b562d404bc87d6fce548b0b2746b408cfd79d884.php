                        ...
                        <div class="sidebar widget advanced-search">
                            ...
                            <form method="post" action="<?php echo e(route('property_search')); ?>">
                               ...
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                     <input type="text" name="keyword" class="form-control selectpicker" placeholder="Keyword..." style="font-size: 14px;font-weight: 300;" id="keyword">
                                </div>
                        <!--    <div class="row">
...
</html><?php /**PATH /opt/lampp/htdocs/Property_Laravel_Project/resources/views/frontend/property_template.blade.php ENDPATH**/ ?>